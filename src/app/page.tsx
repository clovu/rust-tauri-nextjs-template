...
export default function Home() {
  ...
  const nextjsUrl = "https://nextjs.org/docs?" +
    "utm_source=create-next-app&utm_medium=appdir-template&utm_campaign=create-next-app"
    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex">
        ...
        <div className="fixed bottom-0 left-0 flex h-48 w-full items-end justify-center
          ...
          <a
            className="
              pointer-events-none flex place-items-center gap-2 p-8 lg:pointer-events-autolg:p-0
            "
            href={vercelUrl}
            target="_blank"
      ...
      <div className="relative z-[-1] flex place-items-center before:absolute before:h-[300px]
             ...
             after:dark:via-[#0141ff] after:dark:opacity-40 sm:before:w-[480px] sm:after:w-[240px]
             before:lg:h-[360px]">
        <Image
